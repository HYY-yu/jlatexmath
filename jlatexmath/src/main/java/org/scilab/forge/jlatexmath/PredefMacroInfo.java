    ...
    private static final Object invokeID(final int id, final TeXParser tp, final String[] args) throws ParseException {
        try {
            switch (id) {
                ...
                //New Add
                case 301:
                    return PredefMacros.hbox_macro(tp, args);
                case 302:
                    return PredefMacros.root_macro(tp, args);
                case 303:
                    return PredefMacros.enskip_macro(tp, args);
                case 304:
                    return PredefMacros.noalign_macro(tp, args);
                case 305:
                    return PredefMacros.halign_macro(tp, args);
                case 306:
                    return PredefMacros.nointerline_macro(tp, args);
                case 307:
                    return PredefMacros.romannumeral_macro(tp, args);
                case 308:
                    return PredefMacros.uppercase_macro(tp, args);
                case 309:
                    return PredefMacros.time_macro(tp, args);
